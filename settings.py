# Django settings for livingbib project.
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_DIR, 'living.db'),              # Or path to database file if using sqlite3.
...
LOGGING = {
    ...
    'handlers': {
        ...
        'log_files': {
            ...
            'filename': os.path.join(PROJECT_DIR, 'logs/living.log'),
            'formatter': 'default'
        }
    },
    'loggers': {
